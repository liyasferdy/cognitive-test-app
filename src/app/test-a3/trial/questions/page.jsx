...
export default function TrialQuestionsRG() {
  ...
  const handleButtonClick = () => {
    if (timeLeft > 0) {
      ...
      router.push("/test-a3/questions"); // If time is up, navigate directly
    }
  };
  ...
  const handleContinue = () => {
    ...
    router.push("/test-a3/questions"); // Proceed to next page
  };
            ...
            <Card>
              ...
              <CardBody>
                ...
                <div className="flex items-center justify-start">
                  <p className="text-md text-left mt-1 ml-16">
                    Meaningful Memory
                  </p>
                </div>
              </CardBody>
