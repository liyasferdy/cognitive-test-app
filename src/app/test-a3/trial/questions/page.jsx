...
export default function TrialQuestionsVLS() {
  ...
  const handleButtonClick = () => {
    ...
    if (timeLeft > 0) {
      ...
      router.push("/test-a3/trial/questions/"); // If time is up, navigate directly
    }
  };

  const handleNavigation = () => {
    router.push("/test-a3/questions");
  };
  ...
  const questions = [
    {
      number: 1,
      text: "Seorang pelajar mendapatkan uang saku Rp15.000,- per hari. Berapa jumlah uang saku yang diterima dalam waktu 5 hari?",
      options: [
        "Rp50.000,-",
        "Rp60.000,-",
        "Rp65.000,- ",
