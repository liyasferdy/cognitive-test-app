...
export default function InstructionA3() {
  const router = useRouter();

  const handleNavigation = () => {
    router.push("/test-a3/trial/questions");
  };
        ...
        <Card className="w-full sm:max-w-[60rem] px-5 sm:px-20 py-10 relative sm:bottom-40 min-h-[400px]">
          <CardBody>
            ...
            <p className="text-justify mt-5 indent-8 leading-loose">
              Tes berikut terdiri dari soal-soal hitungan. Tugas Anda adalah
              menentukan jawaban yang tepat berdasarkan soal yang disajikan.
            </p>
          </CardBody>
