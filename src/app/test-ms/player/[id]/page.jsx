...
export default function TestMS() {
  ...
  useEffect(() => {
    if (timeLeft === 0) {
      ...
      router.push(`/test-ms/player/${id}/questions`);
      return;
    }
  ...
  const handleButtonClick = () => {
    if (timeLeft > 0) {
      ...
      router.push(`/test-ms/player/${id}/question`); // If time is up, navigate directly
    }
  };
  ...
  const handleContinue = () => {
    ...
    router.push(`/test-ms/player/${id}/question`); // Proceed to next page
  };
