...
export default function TrialQuestionsVLSA() {
  ...
  const handleButtonClick = () => {
    ...
    if (timeLeft > 0) {
      ...
      router.push("/test-vl-SA/trial/questions/"); // If time is up, navigate directly
    }
  };
  ...
  const questions = [
    {
      number: 1,
      text: "Gesit = _____",
      options: ["Lambat", "Pelan", "Lincah", "Gerak", "Reaksi "],
      correctAnswer: "Lincah",
    },
    {
      number: 2,
      text: "Pintar >< _____",
