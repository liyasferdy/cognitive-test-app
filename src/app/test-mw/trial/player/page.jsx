...
export default function TrialTestMW() {
  ...
  useEffect(() => {
    if (timeLeft === 0) {
      router.replace("/test-mw/trial/player/questions");
      return;
    }
  ...
  const handleButtonClick = () => {
    if (timeLeft > 0) {
      ...
      router.push("/test-mw/trial/player/questions"); // If time is up, navigate directly
    }
  };
  ...
  const handleContinue = () => {
    ...
    router.push("/test-mw/trial/player/questions"); // Proceed to next page
  };
