...
export default function trialMV() {
  ...
  const handleButtonClick = () => {
    if (timeLeft > 0) {
      ...
      router.push("/test-mv/trial/picture/questions"); // If time is up, navigate directly
    }
  };
  ...
  const handleContinue = () => {
    ...
    router.push("/test-mv/trial/picture/questions"); // Proceed to next page
  };
  ...
  return (
    <div className="pt-20 flex flex-col justify-between items-center min-h-screen">
      {/* First Modal */}
      {isModalOpen && (
        <Modal isOpen={true} onClose={handleModalAction} placement="top-center">
          <ModalContent>
            {() => (
              <>
