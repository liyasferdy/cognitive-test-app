...
export default function InstructionVLSentence() {
  const router = useRouter();

  const handleNavigation = () => {
    router.push("/test-vl-S/trial/questions");
  };
        ...
        <Card className="w-full sm:max-w-[60rem] px-5 sm:px-20 py-10 relative sm:bottom-40 min-h-[400px]">
          <CardBody>
            <h1 className="text-slate-900 text-lg sm:text-xl text-center font-semibold">
              Instruksi - Test VL Sentence
            </h1>
            <p className="text-justify mt-5 indent-8 leading-loose">
              Anda akan disuguhkan sebuah kalimat tidak lengkap. Tugas Anda
              adalah mencari kata yang tepat untuk melengkapi kalimat tersebut
              menjadi satu kalimat utuh yang bermakna.
            </p>
          </CardBody>
