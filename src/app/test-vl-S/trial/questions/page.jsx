...
export default function TrialQuestionsVLS() {
  ...
  const [timeLeft, setTimeLeft] = useState(60); // set time left
  ...
  const handleButtonClick = () => {
    ...
    if (timeLeft > 0) {
      ...
      router.push("/test-vl-S/trial/questions/"); // If time is up, navigate directly
    }
  };

  const handleNavigation = () => {
    router.push("/test-vl-S/questions");
  };
  ...
  //   router.push("/test-rq/trial/article/questions"); // Redirect to the desired page
  // };
  ...
  const questions = [
    {
      number: 1,
      text: "Lampu kamar yang mulai meredup menjadi lebih _______ setelah diganti dengan lampu baru.",
      options: ["padam", "cerah", "terang", "putih", "gelap "],
