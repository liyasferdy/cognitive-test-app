...
export default function TrialQuestionsVLSentence() {
  ...
  const handleButtonClick = () => {
    if (timeLeft > 0) {
      ...
      router.push("/test-rq/instruction"); // If time is up, navigate directly
    }
  };
  ...
  const handleContinue = () => {
    ...
    router.push("/test-vl-S/questions"); // Proceed to next page
  };
