...
export default function InstructionRC() {
        ...
        <Card className="w-full sm:max-w-[60rem] px-5 sm:px-20 py-10 relative sm:bottom-40 min-h-[400px]">
          <CardBody>
            ...
            <p className="text-justify mt-5 indent-8 leading-loose">
              Tes berikut Anda akan disuguhkan dengan beberapa bacaan. Tugas
              Anda adalah menjawab pertanyaan yang disajikan menggunakan
              informasi dari bacaan yang disediakan. Gunakan waktu Anda
              semaksimal mungkin.
            </p>
          </CardBody>
