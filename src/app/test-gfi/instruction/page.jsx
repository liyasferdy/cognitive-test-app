...
export default function InstructionGFI() {
        ...
        <Card className="w-full sm:max-w-[60rem] px-5 sm:px-20 py-10 relative sm:bottom-40 min-h-[400px]">
          <CardBody>
            ...
            <p className="text-justify mt-5 indent-8 leading-loose">
              Anda akan disajikan beberapa persoalan dalam bentuk gambar-gambar
              berbentuk matrix 3x3. Salah satu bagian dari gambar dihilangkan.
              Tugas Anda adalah mencari gambar yang hilang dengan melihat pola
