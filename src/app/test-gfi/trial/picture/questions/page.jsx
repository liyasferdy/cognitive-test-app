...
export default function QuestionTrialGFI() {
  ...
  const handleButtonClick = () => {
    if (timeLeft > 0) {
      ...
      router.push("/test-gfi/image/1"); // If time is up, navigate directly
    }
  };
  ...
  const handleContinue = () => {
    ...
    router.push("/test-gfi/image/1"); // Proceed to next page
  };
        ...
        {isCorrectModalOpen && (
          ...
          >
            <ModalContent>
              ...
              <ModalFooter>
                <Link href="/test-gfi/trial/picture">
                  <Button
                    color="warning"
