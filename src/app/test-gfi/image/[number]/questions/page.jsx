...
export default function QuestionGFI() {
  ...
  useEffect(() => {
    ...
    if (timeLeft === 0) {
      ...
      if (imageNumber < imageData.length - 1) {
        router.push(`/test-gfi/image/${imageNumber + 2}`);
      } else {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4">
      {/* Jika imageNumber tidak valid, tampilkan pesan error alih-alih return sebelum Hooks */}
      {!isValidImageNumber ? (
          ...
          <div className="bg-white p-6 rounded-md shadow-lg w-96">
            ...
            <div className="flex justify-center">
              <Button
                color="primary"
                onClick={async () => {
                  router.push("/test-vz/instruction"); // Arahkan ke /home setelah submit selesai
                }}
                size="lg"
