...
export default function InstructionRQ() {
  const router = useRouter();

  const handleNavigation = () => {
    router.push("/test-rq/trial/questions");
  };
        ...
        <Card className="w-full sm:max-w-[60rem] px-5 sm:px-20 py-10 relative sm:bottom-40 min-h-[400px]">
          <CardBody>
            ...
            <p className="text-justify mt-5 indent-8 leading-loose">
              Anda akan dihadapkan dengan angka yang berderet serta memiliki
              pola tertentu. Tugas Anda adalah menentukan angka yang tepat untuk
