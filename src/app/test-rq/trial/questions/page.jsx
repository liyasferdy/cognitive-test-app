...
export default function TrialQuestionsRG() {
  ...
  const handleButtonClick = () => {
    ...
    if (timeLeft > 0) {
      ...
      router.push("/test-rq/trial/questions/"); // If time is up, navigate directly
    }
  };

  const handleNavigation = () => {
    router.push("/test-rq/questions");
  };
  ...
  const questions = [
    {
      number: 1,
      number: 1,
      text: "2, 4, 6, 8, 10, 12, …, 16",
      options: ["13", "14", "15", "17", "18"],
      correctAnswer: "14",
    },
    {
      number: 2,
      text: "4000, 2000, 1000, 500, 250, …",
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <div className="flex items-center justify-start">
                    <p className="text-lg text-left mt-1 ml-16">RQ</p>
                  </div>
                </CardBody>
              </Card>
            </div>
